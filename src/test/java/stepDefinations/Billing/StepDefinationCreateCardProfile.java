...
import com.sus.api.scm.utils.DataBaseUtil;
import com.sus.api.scm.utils.JsonUtil;
import com.sus.api.scm.utils.SqlQuery;
...
public class StepDefinationCreateCardProfile extends Utils {
	...
	JsonUtil jsUtil = new JsonUtil(Filepaths.sOneTimePaymentCCJsonFP, "createProfileCC.json");
		...
		if (!countRefNum.equals("0")) {
			try {
				...
				while (rs.next()) {
					...
					APIResources resourceAPI = APIResources.valueOf("PaymentProfile");
