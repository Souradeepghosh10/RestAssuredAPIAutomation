...
import com.sus.api.scm.pojo.LoginPayload;
import com.sus.api.scm.pojo.OneTimePaymentBank;
import com.sus.api.scm.pojo.OneTimePaymentCreditCard;
import com.sus.api.scm.pojo.PaymentProfile;
import com.sus.api.scm.pojo.Registration;
...
public class TestDataBuild {
	...
	JsonUtil jsUtil_login = new JsonUtil(Filepaths.sOneTimePaymentCCJsonFP, fileLogin);
	JsonUtil jsUtil_OTP_CC = new JsonUtil(Filepaths.sOneTimePaymentCCJsonFP, fileOTP_CC);
	JsonUtil jsUtil_paymentProfile_CC = new JsonUtil(Filepaths.sOneTimePaymentCCJsonFP, filePaymentProfile_CC);
	JsonUtil jsUtil_Registration = new JsonUtil(Filepaths.sOneTimePaymentCCJsonFP, fileRegistration);
	...
	public LoginPayload getLoginPayLoad(String userName, String passWord) {
		LoginPayload login = new LoginPayload(jsUtil_login.getStringJsonValue("UpdatedDate"),
				jsUtil_login.getStringJsonValue("Deviceid"), jsUtil_login.getStringJsonValue("LanguageCode"), passWord,
				userName, jsUtil_login.getStringJsonValue("UtilityAccountNumber"),
				jsUtil_login.getStringJsonValue("LoginMode"), jsUtil_login.getStringJsonValue("IsCSRUser"),
				jsUtil_login.getStringJsonValue("ExternalLoginId"), jsUtil_login.getStringJsonValue("PushToken"),
				jsUtil_login.getStringJsonValue("LUpdHideShow"), jsUtil_login.getStringJsonValue("TimeOffSet"),
	...
	public PaymentProfile getPaymentProfile() {
		pp_cc = new PaymentProfile(Integer.parseInt(jsUtil_paymentProfile_CC.getStringJsonValue("UserID")),
				...
				Integer.parseInt(jsUtil_paymentProfile_CC.getStringJsonValue("PayTypeId")),
				Integer.parseInt(jsUtil_paymentProfile_CC.getStringJsonValue("IsBankAccount")),
				Integer.parseInt(jsUtil_paymentProfile_CC.getStringJsonValue("Mode")), jsUtil_paymentProfile_CC.getStringJsonValue("CardName"),
				jsUtil_paymentProfile_CC.getStringJsonValue("CardType"), jsUtil_paymentProfile_CC.getStringJsonValue("CardNumber"),
				Integer.parseInt(jsUtil_paymentProfile_CC.getStringJsonValue("ExpiryMonth")),
				Integer.parseInt(jsUtil_paymentProfile_CC.getStringJsonValue("ExpiryYear")), jsUtil_paymentProfile_CC.getStringJsonValue("SecurityCode"),
				Integer.parseInt(jsUtil_paymentProfile_CC.getStringJsonValue("PaymentMode")), jsUtil_paymentProfile_CC.getStringJsonValue("LanguageCode"),
				jsUtil_paymentProfile_CC.getStringJsonValue("UtilityAccountNumber"), jsUtil_paymentProfile_CC.getStringJsonValue("PaymentToken"),
				jsUtil_paymentProfile_CC.getStringJsonValue("CustomerRefNum"), Integer.parseInt(jsUtil_paymentProfile_CC.getStringJsonValue("ChannelType")),
				jsUtil_paymentProfile_CC.getStringJsonValue("IP"));
		return pp_cc;
	}
