...
public class Filepaths {
	...
	public static String sGlobalProp = System.getProperty("user.dir") + File.separator + "src" + File.separator + "main"
			+ File.separator + "java" + File.separator + "resources" + File.separator + "global.properties";
	
	public static String sEnvProp = System.getProperty("user.dir") + File.separator + "src" + File.separator + "main"
			+ File.separator + "java" + File.separator + "resources" + File.separator + "env.properties";
	...
	public static String sOneTimePaymentCCJsonFP = System.getProperty("user.dir") + File.separator + "src"
			+ File.separator + "test" + File.separator + "java" + File.separator + "testDataJson" + File.separator;
	public static String sInsertOutagePayloadFP = System.getProperty("user.dir") + File.separator + "src"
			+ File.separator + "test" + File.separator + "java" + File.separator + "data" + File.separator + "api"
